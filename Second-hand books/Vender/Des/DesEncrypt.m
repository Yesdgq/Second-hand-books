...
{
    return encryptWithKeyAndType(text, kCCEncrypt, "Cjh56*-9&#^HJHD&&@!DP0N##$%^&**())LLJGHDAQAZZnm20181-asdfdddc777&&*334");
}

static const char* decryptText(const char *text)
{
    return encryptWithKeyAndType(text, kCCDecrypt, "Cjh56*-9&#^HJHD&&@!DP0N##$%^&**())LLJGHDAQAZZnm20181-asdfdddc777&&*334");
}
